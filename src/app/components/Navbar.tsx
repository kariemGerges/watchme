...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <span className="absolute -top-2 -right-2 bg-amber-400 text-black text-xs w-5 h-5 flex items-center justify-center rounded-full">2</span>
          </Link>
      ...
      {/* Mobile menu */}
      <div 
        className={`mobile-menu ${mobileMenuOpen ? '' : 'closed'} md:hidden`}
      >
